...
\includegraphics[width=\textwidth]{img/accel-complete}
...
\includegraphics[width=\textwidth]{img/ntsc-complete}
...
\includegraphics[width=\textwidth]{img/full-system}
Below is an image of the user interface (UI) to our correction system:
\includegraphics[width=\textwidth]{img/ui}
